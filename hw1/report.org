...
#+INCLUDE "code2.py" src python :lines "1-39"
   
   For the requested functions, This code was used:
#+INCLUDE "code2.py" src python :lines "34-68"
...
#+INCLUDE "code2.py" src python :lines "66-116"
* Unigram and Affix Tagger [0/2]
** TODO Unigram Tagger
   This is the code for the Unigram Tagger:
#+INCLUDE "code2.py" src python :lines "118-148"
** TODO Affix Tagger
...
value:
#+INCLUDE "code2.py" src python :lines "258-266"
...
* Fine-grained Error Analysis [1/5]
** DONE Known vs. Unknown Accuracy
   ...
   ~self.wordset = set(word for (word, tag) in sentence in train)~
   
   To every tagger. This could be used in the =evaluate2= method, in
   the following manner:
#+INCLUDE "/home/lxmonk/git/nltk/nltk/tag/api.py" src python :lines "70-88"


** TODO Per Tag Precision and Recall

#+INCLUDE "/home/lxmonk/git/nltk/nltk/tag/api.py" src python :lines "89-119"
